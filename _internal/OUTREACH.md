# Vökuland Wellness — outreach (DRAFT, not sent)

Live preview: https://sindrimar02.github.io/vokuland-preview/  (noindex, preflight PASSED 2026-08-07)

## Contacts (verified same-day 2026-08-07)
| field | value | source |
|---|---|---|
| Practitioner / named owner | **Sólveig** (surname NOT established — do not guess) | ferdalag.is: "meðferð hjá Sólveigu"; guest reviews call her "Solla" |
| Second host | a partner appears in the N4 segment; reviews say "þeirra hjóna". Name NOT established | vokulandwellness.is/vokulandellness-vidtal/ |
| Email | **info@vokulandwellness.is** | Visit North Iceland, Ferdalag.is, Visit Akureyri (site itself obfuscates it) |
| Phone | **663 0498** | site + Visit Akureyri |
| Address | Vökuland 3, 605 Eyjafjarðarsveit (listed as "605 Akureyri") | site /gisting/ |
| Social | facebook.com/… , instagram.com/… , YouTube (icons in site header) | site header |
...
- Current stack: WordPress + Elementor. Booking = a plain Elementor contact form
  (`/boka-i-einstaklingsmedferdir/`). **No scheduler, no booking software, no commission being paid.**
- What it costs them: no vendor fee to displace. The pitch is therefore NOT "we are cheaper".
- Can they afford us: unestablished. Lead with Essential/Growth, never open at Premium.

## SUBJECT
Hugmynd að nýrri vefsíðu fyrir Vökuland

## BODY (send as-is; swap [HLEKKUR] for the live URL)
Sæl Sólveig,

Ég heiti Sindri og hanna vefsíður fyrir íslensk fyrirtæki í ferðaþjónustu og heilsutengdri þjónustu.
